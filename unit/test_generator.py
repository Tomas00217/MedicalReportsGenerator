...
class TestMedicalRecordsGenerator(unittest.TestCase):
    ...
    def test_post_acute_care_with_data(self):
        ...
        self.generator.language.variables["post_treatment_findings"]["post_treatment_infarction"] = "brain infarct"
        self.generator.language.variables["therapies"]["physiotherapy"] = "physiotherapy"
        self.generator.language.variables["therapies"]["speechtherapy"] = "speechtherapy"
    ...
    def test_post_stroke_complications_with_data(self):
        ...
        self.generator.language.variables["post_stroke_complications"]["post_stroke_pneumonia"] = "pneumonia"
        self.generator.language.variables["post_stroke_complications"]["post_stroke_dvt"] = "deep vein thrombosis (DVT)"
        self.generator.language.variables["post_stroke_complications"]["post_stroke_sepsis"] = "drip site sepsis"
    ...
    def test_discharge_with_data(self):
        ...
        self.generator.language.variables["medications"]["discharge_cilostazol"] = "cilostazol"
        self.generator.language.variables["medications"]["discharge_clopidrogel"] = "clopidrogel"
        self.generator.language.variables["medications"]["discharge_ticlopidine"] = "ticlopidine"
